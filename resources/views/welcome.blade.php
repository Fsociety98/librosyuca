...
<div class="container-fluid">
    ...
    <div>
        <div class="row">
            <div class="col">
                <a href="{{ url('/') }}"
                    class="badge badge-primary">{{ 'Todos los libros' }}</a>
                <a href="{{ url('/reciente') }}"
                    class="badge badge-primary">{{ 'Más reciente' }}</a>
                <a href="{{ url('/popular') }}"
                    class="badge badge-primary">{{ 'Más popular' }}</a>
                <a href="{{ url('/gratis') }}"
                    class="badge badge-primary">{{ 'Libros gratis' }}</a>
            </div>
            <div class="col col-lg-4">
                <div class="input-group">
                    <input class="form-control" type="text" placeholder="Enter Keyworks" aria-label="Search"
                        ...
                        <div class="col mb-4">
                            <div style="border-radius: 4px" class="card">
                                <img src="{{ asset('storage').'/'.$libro->imagen }}"
                                    class="card-img-top shadow" width="50" height="270" alt="...">
